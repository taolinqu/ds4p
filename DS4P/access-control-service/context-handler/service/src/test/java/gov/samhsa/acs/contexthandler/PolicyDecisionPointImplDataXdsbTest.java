...
public class PolicyDecisionPointImplDataXdsbTest {
	...
	PolicyDecisionPointImplDataXdsb policyDecisionPointImplDataXdsb
		=new PolicyDecisionPointImplDataXdsb(xdsbRegistry, xdsbRepository,urnPolicyCombiningAlgorithm);

	@Test
	public void testConstructorWithXdsbRegistryAdapterAndXdsbRepositoryAdapter(){
		policyDecisionPointImplDataXdsb=new PolicyDecisionPointImplDataXdsb(xdsbRegistry, xdsbRepository);
	}
